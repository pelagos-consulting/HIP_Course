...
echo "procid is" $SLURM_PROCID

# compile the code
srun CC -x hip mat_mult_profiling.cpp -I../ -I../../include -o mat_mult_profiling.exe
...
#srun -N $SLURM_JOB_NUM_NODES -n $SLURM_NTASKS -c $OMP_NUM_THREADS rocprof -i rocprof_counters.txt -o rocprof_counters/result-$SLURM_JOBID-$SLURM_PROCID.csv ./mat_mult_profiling.exe
